...
output:
  xaringan::moon_reader:
    ...
    seal: false 
    chakra: 'libs/remark-latest.min.js' # Allows for compilation offline.
    includes:
      in_header: "assets/custom.html" # Suppose to add Monash icon to header but doesn't
    mathjax: "assets/mathjax-local/MathJax.js?config=TeX-AMS-MML_HTMLorMML" # Compatiable math formulas accross browsers
    nature:
...
# To changes the end slide: edit ./components/endslide.Rmd, note no yaml.
```
